...
TabularTables.Events = new Tabular.Table({
  ...
  columnDefs: [
    ...
    { "width": "600px", orderable: false, className: "bulletCell", "targets": [ 3 ] }, // bullet graph
  ...
  columns: [
    ...
    {data: 'responseTime', title: 'Response time (ms)', tmpl: Meteor.isClient && Template.responseTimeChartCSS},
